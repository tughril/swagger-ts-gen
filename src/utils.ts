import {BaseSchema, BodyParameter, Operation, Parameter, PathParameter, QueryParameter, Schema as SwaggerSchema} from 'swagger-schema-official';
 ...
 */
export function isBodyParameter(parameter: Parameter):
 ...
 */
export function isPathParameter(parameter: Parameter):
    parameter is PathParameter {
 ...
 */
export function isQueryParameter(parameter: Parameter):
 ...
 */
export function isSchema(schemaOrBaseSchema: BaseSchema|
                         SwaggerSchema): schemaOrBaseSchema is SwaggerSchema {
  const schema: SwaggerSchema = schemaOrBaseSchema as SwaggerSchema;
  return (
      schema.$ref !== undefined || schema.allOf !== undefined ||
      schema.additionalProperties !== undefined ||
      schema.properties !== undefined || schema.discriminator !== undefined ||
      schema.readOnly !== undefined || schema.xml !== undefined ||
      schema.externalDocs !== undefined || schema.example !== undefined ||
...
export function createOperationName(
    method: string, operation: Operation): string {
